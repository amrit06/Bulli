...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($result == true){
    if( !empty($_POST['table2']) && !empty($args['expense']) ){
      ...
      header('Location:cardsaccount.php');
  }else{
      echo "Unsuccess";
  }
  }
...
<div class="topnav">
  ...
  <div class="topnav-right test2">
    ...
    <body class="center">
    <h2 class="h2Style">Create Entry for Cards Account</h2>
    <div class="form">
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
		  	<section class="inputValues">
			    <input type="hidden" name="table" value="Card"br>
			    ...
			    <br><br>
          <label for="userId">Who</label><br>
          <select name="userId" id="userId">
                <option value=""></option>
                <option value="0">Tad Bak</option>
                <option value="1">Anika Joinking</option>
                <option value="2">Peter Lynes</option>
                <option value="3">Peter Robinson</option>
                <option value="4">Peter Zuiderwyk</option>
                <option value="5">Jaydyn Haigh</option>
                <option value="6">Keith Robinson</option>
                <option value="7">Nathan Sparks</option>
                <option value="8">Lawrence Wood</option>
                <option value="9">Michael Clarke</option>
          </select>
        ...
        <section class="completed">
          ...
          <br>
      <a href="cardsaccount.php">Back to list</a>
		</section>
      </form>
    </div>
  </body>
