...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($result == true){
    if( !empty($_POST['table2']) && !empty($args['expense']) ){
      ...
      header('Location:DGRaccount.php');
  }else{
      echo "Unsuccess";
  }
  }
...
<div class="topnav">
  ...
  <div class="topnav-right test2">
    ...
    <body class="center">
    <h2 class="h2Style">Create Entry for DGR Account</h2>
    <div class="form">
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		  	<section class="inputValues">
          <input type="hidden" name="table" value="DGR"/>
        ...
        <section class="completed">
          ...
          <br>
          <a href="DGRaccount.php">Back to list</a>
        </section>
      </form>
    </div>
  </body>
