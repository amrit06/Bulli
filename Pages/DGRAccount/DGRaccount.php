...
<?php
if ($_SESSION['status'] === "admin") {
echo '  <a href="DGRadd.php" class="button">Create New Entry</a>';
}
?>  
    ...
    for ($i = 0; $i < sizeof($result); $i++) {
      echo
        '
              ...
              if ($_SESSION['status'] === "admin") {
                echo '
              <td><a href="DGRmodify.php?id='.$result[$i]['Id'].'" class="button2">Edit Entry</a></td>
              </tr>
              ';}
    }
